    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img2, "alt", "");
    			add_location(img2, file$1, 101, 16, 2870);
    			attr_dev(button2, "class", "c19 hovCovid svelte-1vloheq");
    			add_location(button2, file$1, 94, 12, 2676);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button0, anchor);
    			append_dev(button0, img0);
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(img0, "width", "100%");
    			attr_dev(img0, "alt", "");
    			add_location(img0, file$1, 46, 16, 1176);
    			attr_dev(button0, "class", "c19 svelte-1vloheq");
    			add_location(button0, file$1, 45, 12, 1138);
    			...
    			set_style(img1, "width", "100%");
    			attr_dev(img1, "alt", "");
    			add_location(img1, file$1, 54, 16, 1426);
    			attr_dev(button1, "class", "c19 svelte-1vloheq");
    			add_location(button1, file$1, 53, 12, 1388);
    			...
    			set_style(img2, "width", "100%");
    			attr_dev(img2, "alt", "");
    			add_location(img2, file$1, 62, 16, 1676);
    			attr_dev(button2, "class", "c19 svelte-1vloheq");
    			add_location(button2, file$1, 61, 12, 1638);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button0, anchor);
    			append_dev(button0, img0);
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(img, "width", "100%");
    			attr_dev(img, "alt", "");
    			add_location(img, file$1, 122, 12, 3347);
    			attr_dev(button, "class", "modal-covid svelte-1vloheq");
    			add_location(button, file$1, 114, 8, 3161);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, img);
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(img, "width", "100%");
    			attr_dev(img, "alt", "");
    			add_location(img, file$1, 140, 12, 3766);
    			attr_dev(button, "class", "modal-covid svelte-1vloheq");
    			add_location(button, file$1, 132, 8, 3580);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, img);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(img, "width", "100%");
    			attr_dev(img, "alt", "");
    			add_location(img, file$1, 158, 12, 4185);
    			attr_dev(button, "class", "modal-covid svelte-1vloheq");
    			add_location(button, file$1, 150, 8, 3999);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, img);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$1, 177, 12, 4623);
    			attr_dev(button, "class", "ref2 svelte-1vloheq");
    			add_location(button, file$1, 169, 8, 4438);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, img);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(169:4) {#if reference == \\\"closed\\\"}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$1, 193, 12, 5083);
    			attr_dev(button, "class", "ref svelte-1vloheq");
    			add_location(button, file$1, 185, 8, 4841);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, img);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(185:4) {#if reference == \\\"open\\\"}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$1, 39, 8, 968);
    			attr_dev(div, "class", "text-center");
    			add_location(div, file$1, 38, 4, 933);
    			attr_dev(section, "class", section_class_value = "" + (null_to_empty(/*bg_covid*/ ctx[1]) + " svelte-1vloheq"));
    			add_location(section, file$1, 37, 0, 899);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
